...
UNITREE_MODEL_DIR = "/home/sallu/unitree_rl_lab/unitree_model/"  # Replace with the actual path to your unitree_model directory
UNITREE_ROS_DIR = "/opt/ros/humble/setup.bash"  # Replace with the actual path to your unitree_ros package
